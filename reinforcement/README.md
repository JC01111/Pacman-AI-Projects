...
1. Prefer the close exit (+1), risking the cliff (-10) <br>
    discount = 0.4, noise = 0.01, livingReward = -0.8 <br>
    Which can be tested by running: `python gridworld.py -g DiscountGrid -a value --discount 0.4 --noise 0.01 --livingReward -0.8`

    <img src="../images/rl_2_2.gif" width=350>

2. Prefer the close exit (+1), but avoiding the cliff (-10) <br>
    discount = 0.01, noise = 0.01, livingReward = 0.9 <br>
    Which can be tested by running: `python gridworld.py -g DiscountGrid -a value --discount 0.01 --noise 0.01 --livingReward 0.9`

    <img src="../images/rl_2_3.gif" width=350>

3. Prefer the distant exit (+10), risking the cliff (-10) <br>
    discount = 0.8, noise = 0.01, livingReward = -0.8 <br>
    Which can be tested by running: `python gridworld.py -g DiscountGrid -a value --discount 0.8 --noise 0.01 --livingReward -0.8`

    <img src="../images/rl_2_4.gif" width=350>

4. Prefer the distant exit (+10), avoiding the cliff (-10) <br>
    discount = 0.9, noise = 0.2, livingReward = 0.9 <br>
    Which can be tested by running: `python gridworld.py -g DiscountGrid -a value --discount 0.9 --noise 0.2 --livingReward 0.9`

   <img src="../images/rl_2_5.gif" width=350> 

5. Avoid both exits and the cliff (so an episode should never terminate) <br>
    discount = 1, noise = 0.8, livingReward = 0.9 
    
    Which can be tested by running: `python gridworld.py -g DiscountGrid -a value --discount 1 --noise 0.8 --livingReward 0.9`

    <img src="../images/rl_2_6.gif" width=350>
